...
syn match crystalPredefinedConstant "\%(\%(^\|[^.]\)\.\s*\)\@<!\<\%(ARGF\|ARGV\|ENV\|DATA\|FALSE\|NIL\|STDERR\|STDIN\|STDOUT\|TRUE\)\>\%(\s*(\)\@!"
...
syn match   crystalKeyword	       "\<\%(super\|yield\|as\|of\|out\|pointerof\|uninitialized\|sizeof\|instance_sizeof\|typeof\)\>[?!]\@!"
